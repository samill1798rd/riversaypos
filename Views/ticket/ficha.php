...
<?php
  ...
  echo'------------------------------------------------------------------------------';
	echo ' <br>';
  	echo '<thead><tr><td width="40"></td><td width="60"><b>Cant.</b></td><td width="120"><b>Desc.</b></td><td width="80"><b>Tipo</b></td><td width="80"><b>Precio</b></td><td><b>Total</b></td></tr></thead>';
for ($i=0; $i<$numfilas; $i++)
	{
		$fila = mysql_fetch_array($pacientes);
		echo '<td >'.'</td>';
...
<?PHP
   ...
   echo 'Atendido por : ';
   echo '<b>'; echo $atendido; echo ' ';  echo '</b>';
